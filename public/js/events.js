...
var SORT_BY = {
  ...
  */
	"no-order": function noOrder(data) {
		return data;
	},
	/**
  * Sort the list by comparing the name of the events.
  */
	"name-asc": function nameAsc(data) {
  ...
  */
	"name-desc": function nameDesc(data) {
		return data.sort(function (a, b) {
			if (a.name > b.name) return -1;else if (b.name > a.name) return 1;else return 0;
		});
	},
  ...
  */
	"like-asc": function likeAsc(data) {
		return data.sort(function (a, b) {
  ...
  */
	"like-desc": function likeDesc(data) {
		return data.sort(function (a, b) {
  ...
  */
	"date-asc": function dateAsc(data) {
		return data.sort(function (a, b) {
  ...
  */
	"date-desc": function dateDesc(data) {
		return data.sort(function (a, b) {
...
function orderAndFilter(data) {
	return SORT_BY[$("#order-select").val()](data.filter(function (e) {
		return !$("#filter-sport").is(":checked") ? e.category != $("#filter-sport").val() : true;
	}).filter(function (e) {
		return !$("#filter-culture").is(":checked") ? e.category != $("#filter-culture").val() : true;
	}).filter(function (e) {
		return !$("#filter-others").is(":checked") ? e.category != $("#filter-others").val() : true;
	}));
}
/**
